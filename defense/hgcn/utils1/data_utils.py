...
def load_data_nc(dataset, use_feats, data_path, split_seed):
    if dataset in ['cora', 'citeseer', 'polblogs', 'cora_ml']:
...
def load_citation_data(dataset_str, attack, data_path, split_seed=None):

    data = Dataset(root=data_path, name=dataset_str, seed=15, require_mask=True)
